          ...
          <div className="mt-8 flex flex-col gap-3">
            ...
            <div className="mb-2 flex items-center gap-2">
              <div className="flex h-5 items-center">
                <div className="flex h-4 w-4 cursor-default items-center justify-center rounded-sm bg-[#1f6feb] shadow-sm">
                  <Check className="h-3 w-3 text-white" />
                </div>
              </div>
              <span className="cursor-default text-sm text-[#8b949e]">
                I agree to the{" "}
                <Link
                  href="/terms"
                  className="text-[#58a6ff] transition-colors hover:text-[#79b8ff] hover:underline"
                >
                  Terms & conditions
                </Link>
              </span>
            ...
            >
              <button
                type="submit"
                className="flex w-full cursor-pointer items-center justify-center gap-3 rounded border border-[#30363d] bg-[#21262d] px-4 py-2.5 text-sm font-medium text-[#c9d1d9] shadow-sm transition-all hover:bg-[#30363d] hover:text-white active:scale-[0.98]"
              >
                <svg
